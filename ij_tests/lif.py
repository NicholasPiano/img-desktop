# script to extract relevant information about a series from the omexml database
...
def series_metadata(experiment_name, series_name):
  ...
  content = ''
  with open('./{}.txt'.format(experiment_name)) as omexml:
    content = omexml.read()
