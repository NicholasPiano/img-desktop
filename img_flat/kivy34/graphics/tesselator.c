 ...
 * 
 */
  __pyx_tuple__16 = PyTuple_Pack(7, __pyx_n_s_Tesselator, __pyx_n_s_WINDING_ODD, __pyx_n_s_WINDING_NONZERO, __pyx_n_s_WINDING_POSITIVE, __pyx_n_s_WINDING_NEGATIVE, __pyx_n_s_TYPE_POLYGONS, __pyx_n_s_TYPE_BOUNDARY_CONTOURS); if (unlikely(!__pyx_tuple__16)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 
 */
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_all, __pyx_tuple__16) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 61; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
