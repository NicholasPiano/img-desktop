...
class Channel(models.Model):
  ...
  def segment(self, marker_channel_name):
    ...
    print('run pipeline')
    unique, suffix_id = self.composite.experiment.save_marker_pipeline(series_name=self.composite.series.name, primary_channel_name='s{}_ch{}'.format(self.composite.series.name, marker_channel_primary_name), secondary_channel_name='s{}_ch{}'.format(self.composite.series.name, self.name))
